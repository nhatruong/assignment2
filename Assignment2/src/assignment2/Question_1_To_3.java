...
public class Question_1_To_3 {

	public Question_1_To_3() {
...
*/
	public  double employeeSalary(double hours) {
		...
		if(hours <= 0)
			throw new IllegalArgumentException("Min Working hours is 1 hour");
		if(hours > 48)
			throw new IllegalArgumentException("Max working hours is 48 hours");
